...
// `chip35-dl-coin-wasm`. The package we publish to npm is the SCOPED
// `@dignetwork/chip35-dl-coin-wasm`, and it must publish with public access.
//
...
const SCOPED_NAME = "@dignetwork/chip35-dl-coin-wasm";
...
pkg.main ??= "chip35_dl_coin_wasm.js";
pkg.types ??= "chip35_dl_coin_wasm.d.ts";
